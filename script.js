...
const translations = {
  ar: {
    name: "سوسن أحمد العجاب",
    title: "مطورة واجهة أمامية",
    nav_about: "نبذة",
    nav_skills: "مهارات",
    nav_projects: "مشاريع",
    nav_contact: "تواصل",
    ...
    see_projects: "اطلع على مشاريعي",
    contact_me: "أرسل رسالة",
    about_heading: "نبذة عني",
    about_text: "طالبة تكنولوجيا معلومات ومطوّرة واجهة أمامية شغوفة ببناء واجهات مستخدم جذابة وفعّالة.",
    skills_heading: "مهاراتي التقنية",
    skill1: "HTML و CSS",
    skill2: "JavaScript",
    skill3: "Bootstrap و GitHub",
  ...
  en: {
    ...
    about_text: "IT student and front-end developer passionate about creating elegant, functional user interfaces.",
    skills_heading: "Technical Skills",
    skill1: "HTML & CSS",
    skill2: "JavaScript",
    skill3: "Bootstrap & GitHub",
  ...
  de: {
    ...
    about_text: "IT-Studentin und Front-End-Entwicklerin mit Leidenschaft für funktionale, elegante Benutzeroberflächen.",
...
// حدث تغيير اللغة عند الضغط على الزر
...
// بدء الترجمة تلقائياً عند تحميل الصفحة
updateTexts();
